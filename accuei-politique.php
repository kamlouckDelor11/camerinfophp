...
//les meta données indépendqntes
    $_title = "Camer info club : l'actualité politique du ,onde en cotinue";
    $_description = "Suivez toute l'actualité politique - Camer info club  du monde en directe";
?>
<?php
    include('head.php');
?>
                            ...
                            <article> 
                                <a href="#">
                                    <div class='row__article article__col-img'>
                                        <img src="images/sport/img-maroc-portugal-mondiale-2022.JPG" alt="photo equipe du maroc au qatar 2022">
                                    </div>
                ...
                <div class="article-col-2">
                    <article> 
                        <a href="discours-paul-biya-augmention-prix.php">
                            <div class='row__article article__col-img'>
                                <img src="images/actualite/img__discours__paul__biya__fin__annee__2022.JPG" alt="photo du président paul biya">
                            </div>
